...
function DoorHandle({ sWidth, sHeight, visible=true }) {
...
function Scene({ sWidth, sHeight }) {
    ...
    return (
        <Canvas>
            ...
            <DoorHandle sWidth={sWidth} sHeight={sHeight} visible={true} />
...
function Door1Scene(props) {
    return <Scene sWidth={props.sWidth} sHeight={props.sHeight} />;
}
